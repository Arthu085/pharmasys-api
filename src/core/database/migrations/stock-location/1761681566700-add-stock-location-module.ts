...
export class AddStockLocationModule1761681566700 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "pharmasys"."IDX_bc9c50d19b5caa97f0f51cca0a"`);

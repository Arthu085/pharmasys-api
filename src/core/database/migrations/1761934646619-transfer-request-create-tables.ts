...
export class TransferRequestCreateTables1761934646619 implements MigrationInterface {
    name = 'TransferRequestCreateTables1761934646619'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "pharmasys"."transfer_reason_status_enum" AS ENUM('A', 'I')`);
        await queryRunner.query(`CREATE TABLE "pharmasys"."transfer_reason" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "status" "pharmasys"."transfer_reason_status_enum" NOT NULL DEFAULT 'A', "name" character varying(150) NOT NULL, CONSTRAINT "UQ_3cfb021fa9d54a6ec7bce386502" UNIQUE ("uuid"), CONSTRAINT "UQ_48bc87a7fca01ee21ce272f71aa" UNIQUE ("name"), CONSTRAINT "PK_ddc7acab5c82b80c08bcf561fef" PRIMARY KEY ("id")); COMMENT ON COLUMN "pharmasys"."transfer_reason"."uuid" IS 'Identificador único universal'; COMMENT ON COLUMN "pharmasys"."transfer_reason"."status" IS 'Status da entidade (A-Ativo, I-Inativo)'; COMMENT ON COLUMN "pharmasys"."transfer_reason"."name" IS 'Nome das razões de transferência'`);

...
export class AddItemModule1761681442894 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pharmasys"."presentation" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "status" "pharmasys"."presentation_status_enum" NOT NULL DEFAULT 'A', "name" character varying(100) NOT NULL, CONSTRAINT "UQ_c263fc38170ed8ab08b261ecf4f" UNIQUE ("uuid"), CONSTRAINT "UQ_7c6d5273ad27dffb942581c7128" UNIQUE ("name"), CONSTRAINT "PK_b3d0364e16cd51d8196a13c528d" PRIMARY KEY ("id")); COMMENT ON COLUMN "pharmasys"."presentation"."uuid" IS 'Identificador único universal'; COMMENT ON COLUMN "pharmasys"."presentation"."status" IS 'Status da entidade (A-Ativo, I-Inativo)'; COMMENT ON COLUMN "pharmasys"."presentation"."name" IS 'Nome da apresentação'`);

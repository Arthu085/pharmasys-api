...
export class InventoryEntryCreateTables1761934612795 implements MigrationInterface {
    name = 'InventoryEntryCreateTables1761934612795'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "pharmasys"."entry_item_type_status_enum" AS ENUM('A', 'I')`);
        await queryRunner.query(`CREATE TABLE "pharmasys"."entry_item_type" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "status" "pharmasys"."entry_item_type_status_enum" NOT NULL DEFAULT 'A', "name" character varying(150) NOT NULL, CONSTRAINT "UQ_228b9b5e5c745621d2e7f09844b" UNIQUE ("uuid"), CONSTRAINT "UQ_5de3c7fb8b3461a1f13735268ab" UNIQUE ("name"), CONSTRAINT "PK_0dd762d2b87bc363768afc1474b" PRIMARY KEY ("id")); COMMENT ON COLUMN "pharmasys"."entry_item_type"."uuid" IS 'Identificador único universal'; COMMENT ON COLUMN "pharmasys"."entry_item_type"."status" IS 'Status da entidade (A-Ativo, I-Inativo)'; COMMENT ON COLUMN "pharmasys"."entry_item_type"."name" IS 'Nome dos tipos'`);
        await queryRunner.query(`CREATE INDEX "IDX_228b9b5e5c745621d2e7f09844" ON "pharmasys"."entry_item_type" ("uuid") `);
        await queryRunner.query(`CREATE INDEX "IDX_511ac2c6381264040b0f1a843d" ON "pharmasys"."entry_item_type" ("status") `);
        ...
        await queryRunner.query(`CREATE TABLE "pharmasys"."inventory_entry" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "status" "pharmasys"."inventory_entry_status_enum" NOT NULL DEFAULT 'A', "invoice_number" character varying(70), "entry_date" TIMESTAMP WITH TIME ZONE NOT NULL, "total_value" numeric(12,2), "user_created_id" integer, "user_updated_id" integer, "company_id" integer, "entry_type_id" integer, "stock_location_id" integer, CONSTRAINT "UQ_50301d8e3d314b314861be79a68" UNIQUE ("uuid"), CONSTRAINT "PK_6194458c6b3641b5a2d0388b8b7" PRIMARY KEY ("id")); COMMENT ON COLUMN "pharmasys"."inventory_entry"."uuid" IS 'Identificador único universal'; COMMENT ON COLUMN "pharmasys"."inventory_entry"."status" IS 'Status da entidade (A-Ativo, I-Inativo)'; COMMENT ON COLUMN "pharmasys"."inventory_entry"."invoice_number" IS 'Número da nota fiscal'; COMMENT ON COLUMN "pharmasys"."inventory_entry"."entry_date" IS 'Data de entrada informada pelo usuário'; COMMENT ON COLUMN "pharmasys"."inventory_entry"."total_value" IS 'Valor total se é nota fiscal'`);
        await queryRunner.query(`CREATE INDEX "IDX_50301d8e3d314b314861be79a6" ON "pharmasys"."inventory_entry" ("uuid") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "pharmasys"."IDX_d7184722603301acfafd52c50e"`);
        ...
        await queryRunner.query(`DROP INDEX "pharmasys"."IDX_50301d8e3d314b314861be79a6"`);
        ...
        await queryRunner.query(`DROP INDEX "pharmasys"."IDX_511ac2c6381264040b0f1a843d"`);
        await queryRunner.query(`DROP INDEX "pharmasys"."IDX_228b9b5e5c745621d2e7f09844"`);

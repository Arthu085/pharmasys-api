...
export class ItemCreateTables1761934552212 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pharmasys"."presentation" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "status" "pharmasys"."presentation_status_enum" NOT NULL DEFAULT 'A', "name" character varying(100) NOT NULL, CONSTRAINT "UQ_c263fc38170ed8ab08b261ecf4f" UNIQUE ("uuid"), CONSTRAINT "UQ_7c6d5273ad27dffb942581c7128" UNIQUE ("name"), CONSTRAINT "PK_b3d0364e16cd51d8196a13c528d" PRIMARY KEY ("id")); COMMENT ON COLUMN "pharmasys"."presentation"."uuid" IS 'Identificador único universal'; COMMENT ON COLUMN "pharmasys"."presentation"."status" IS 'Status da entidade (A-Ativo, I-Inativo)'; COMMENT ON COLUMN "pharmasys"."presentation"."name" IS 'Nome da apresentação'`);
        await queryRunner.query(`CREATE INDEX "IDX_c263fc38170ed8ab08b261ecf4" ON "pharmasys"."presentation" ("uuid") `);
        ...
        await queryRunner.query(`CREATE TABLE "pharmasys"."item" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "status" "pharmasys"."item_status_enum" NOT NULL DEFAULT 'A', "name" character varying(255) NOT NULL, "user_created_id" integer, "user_updated_id" integer, "type_id" integer, "presentation_id" integer, "dosage_id" integer, "subtype_id" integer, CONSTRAINT "UQ_eb3fcd003ddc6f23c342885677b" UNIQUE ("uuid"), CONSTRAINT "PK_d3c0c71f23e7adcf952a1d13423" PRIMARY KEY ("id")); COMMENT ON COLUMN "pharmasys"."item"."uuid" IS 'Identificador único universal'; COMMENT ON COLUMN "pharmasys"."item"."status" IS 'Status da entidade (A-Ativo, I-Inativo)'; COMMENT ON COLUMN "pharmasys"."item"."name" IS 'Nome do item'`);
        await queryRunner.query(`CREATE INDEX "IDX_eb3fcd003ddc6f23c342885677" ON "pharmasys"."item" ("uuid") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "pharmasys"."IDX_eb3fcd003ddc6f23c342885677"`);
        ...
        await queryRunner.query(`DROP INDEX "pharmasys"."IDX_9b9d48f39f028d64727fe6f6bf"`);
        ...
        await queryRunner.query(`DROP INDEX "pharmasys"."IDX_c263fc38170ed8ab08b261ecf4"`);
        ...
        await queryRunner.query(`DROP INDEX "pharmasys"."IDX_d0ab156c543d935a8cedafe95f"`);
        ...
        await queryRunner.query(`DROP INDEX "pharmasys"."IDX_e6afc5fa0171f1640c34070afe"`);

...
export class AddInventoryEntryModule1761682465107 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pharmasys"."inventory_entry" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "status" "pharmasys"."inventory_entry_status_enum" NOT NULL DEFAULT 'A', "invoice_number" character varying(70), "entry_date" TIMESTAMP WITH TIME ZONE NOT NULL, "total_value" numeric(12,2), "user_created_id" integer, "user_updated_id" integer, "company_id" integer, "entry_type_id" integer, "stock_location_id" integer, CONSTRAINT "UQ_50301d8e3d314b314861be79a68" UNIQUE ("uuid"), CONSTRAINT "PK_6194458c6b3641b5a2d0388b8b7" PRIMARY KEY ("id")); COMMENT ON COLUMN "pharmasys"."inventory_entry"."uuid" IS 'Identificador único universal'; COMMENT ON COLUMN "pharmasys"."inventory_entry"."status" IS 'Status da entidade (A-Ativo, I-Inativo)'; COMMENT ON COLUMN "pharmasys"."inventory_entry"."invoice_number" IS 'Número da nota fiscal'; COMMENT ON COLUMN "pharmasys"."inventory_entry"."entry_date" IS 'Data de entrada informada pelo usuário'; COMMENT ON COLUMN "pharmasys"."inventory_entry"."total_value" IS 'Valor total se é nota fiscal'`);

...
export class AddInventoryExitTable1761659790979 implements MigrationInterface {
    name = 'AddInventoryExitTable1761659790979'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pharmasys"."inventory_exit" ("id" SERIAL NOT NULL, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "status" "pharmasys"."inventory_exit_status_enum" NOT NULL DEFAULT 'A', "exit_date" TIMESTAMP WITH TIME ZONE NOT NULL, "notes" text NOT NULL, "user_created_id" integer, "user_updated_id" integer, "exit_type_id" integer, CONSTRAINT "PK_b58bfbf5288bf9ed126d8bf807f" PRIMARY KEY ("id")); COMMENT ON COLUMN "pharmasys"."inventory_exit"."uuid" IS 'Identificador único universal'; COMMENT ON COLUMN "pharmasys"."inventory_exit"."status" IS 'Status da entidade (A-Ativo, I-Inativo)'; COMMENT ON COLUMN "pharmasys"."inventory_exit"."exit_date" IS 'Data de saída informada pelo usuário'; COMMENT ON COLUMN "pharmasys"."inventory_exit"."notes" IS 'Anotações da saída'`);
